...
async def _async_setup_component(hass, domain, config):
    """Route deleted Automation product setup to the test-only runtime harness."""
...
# Keep production imports honest: expose the harness only as an attribute used by
# component tests. We intentionally do not register a
