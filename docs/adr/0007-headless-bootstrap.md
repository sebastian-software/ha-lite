...
Recovery mode must be redefined as an operational/API recovery path. ADR 0016 did that: recovery sets up the API surface on purpose and reports why it started, and first run and administration are defined alongside it.
