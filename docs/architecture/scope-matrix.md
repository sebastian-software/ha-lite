...
4. Unselected integrations, deleted by reachability from the computed closure. **Done, then reversed:** deleting the catalog was never the goal. ADR 0020 restored every integration that loads without a removed layer.
