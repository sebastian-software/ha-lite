...
Representative integrations drive the transitive closure: Shelly, MQTT, Matter, Hue, Fronius and Modbus, plus Miele as the OAuth anchor that exercises application credentials, external authorization and reauthentication (ADR 0017).
